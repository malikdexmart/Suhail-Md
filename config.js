...
module.exports = {
  ...
  author : process.env.PACK_AUTHER|| "zuuh",
  packname: process.env.PACK_NAME || "zuuh",
  botname : process.env.BOT_NAME  || "zuuh-dedmart",
